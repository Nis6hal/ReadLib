...
import { Play, Check, Plus, X, Trash2, Pencil, Save, Star } from "lucide-react";
...
function BookCard({
  ...
  const handleSaveEdit = async () => {
    ...
    const updated = {
      ...book,
      title: trimTitle,
      author: trimAuthor || "Unknown Author",
      genre: editGenre,
    };
    await updateBook(updated);
    setIsEditing(false);
        ...
        <div className="book-list-item card">
          ...
          <div className="book-list-meta">
            ...
            <div className="list-progress">
              ...
              <span className="progress-value-sm">
            ...
            {isEditing ? (
              ...
              <>
                <button className="btn btn-primary btn-sm" onClick={handleRead}>
                  <Play size={13} fill="currentColor" /> Read
                </button>
                <button
                  className="btn-icon-sm"
                  onClick={handleEdit}
                ...
                <button
                  className={`btn-icon-sm ${confirmDelete ? "btn-danger-icon" : ""}`}
