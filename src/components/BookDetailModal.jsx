...
function BookDetailModal({ book, onClose }) {
  ...
  const handleRead = () => {
    if (book.fileMissing) {
      addToast(
        "File is missing from your local folder. Reading record preserved.",
        "info",
      );
      return;
    }
  ...
  return createPortal(
    ...
    >
      <div
        className={`modal-content book-detail-modal card ${isClosing ? "closing" : ""}`}
          ...
          <div className="modal-right">
            ...
            <div className="modal-header">
              <div className="modal-title-row">
                {editingTitle ? (
                  <div className="inline-edit-wrap">
                    <input
                      ...
                      autoFocus
                    />
                    <button className="inline-edit-save" onClick={saveTitle}>
                      <Check size={16} />
                    </button>
                  </div>
                ) : (
                ...
                <button
                  className={`favorite-btn-large ${book.isFavorite ? "active" : ""}`}
              ...
              {editingAuthor ? (
                ...
                <p
                  className="modal-author editable-author"
              ...
              {book.fileMissing && (
                ...
                >
                  ⚠️ Physical file has been deleted or moved, but your reading
                ...
                <div className="modal-section">
                  ...
                  <div className="progress-container modal-progress">
                    <div className="progress-header">
                      ...
                      {book.pageCount > 0 && (
                        <span className="page-count-hint">
                          {Math.round(
                            ((book.progress || 0) / 100) * book.pageCount,
                          )}{" "}
              ...
              <div className="tab-panel">
                {similarBooks.length > 0 ? (
                    ...
                    {similarBooks.map((b) => {
                      ...
                      return (
                        <div
                          ...
                          onClick={() =>
                            navigate(`/read/${encodeURIComponent(b.id)}`)
                          }
                        >
                          <div
                  ...
                  <div className="similar-empty">
                    ...
                    <span>
                      Add more books with the same genre or author to see
                      suggestions.
                    </span>
                  </div>
                )}
